...
def Main():
    ...
    site.add_dir('أفلام أجنبية', site.url + '/genre/english-movies/', 'getMovies', site.image)
    site.add_dir('أفلام عربية', site.url + '/genre/arabic-movies/', 'getMovies', site.image)
    site.add_dir('أفلام تركية', site.url + '/genre/turkish-movies/', 'getMovies', site.image)
    site.add_dir('أفلام هندية', site.url + '/genre/indian-movies/', 'getMovies', site.image)
    site.add_dir('أفلام كرتون', site.url + '/genre/animation/', 'getMovies', site.image)
    site.add_dir('مسلسلات أجنبية', site.url + '/genre/english-series/', 'getTVShows', site.image)
    site.add_dir('مسلسلات عربية', site.url + '/genre/arabic-series/', 'getTVShows', site.image)
    site.add_dir('مسلسلات تركية', site.url + '/genre/turkish-series/', 'getTVShows', site.image)
    site.add_dir('مسلسلات هندية', site.url + '/genre/indian-series/', 'getTVShows', site.image)
    site.add_dir('مسرحيات', site.url + '/genre/plays/', 'getMovies', site.image)
    utils.eod()
