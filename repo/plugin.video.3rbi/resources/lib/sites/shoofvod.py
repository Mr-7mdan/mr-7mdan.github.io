...
def Main():
    ...
    site.add_dir('مسلسلات رمضان', site.url + '/Cat-145-1', 'getTVShows', site.image)
    site.add_dir('أفلام أجنبية', site.url + '/al_751319_1', 'getMovies', site.image)
    site.add_dir('أفلام عربية', site.url + '/Cat-100-1', 'getMovies', site.image)
    site.add_dir('أفلام تركية', site.url + '/Cat-48-1', 'getMovies', site.image)
    site.add_dir('أفلام هندية', site.url + '/Cat-132-1', 'getMovies', site.image)
    site.add_dir('أفلام إنمي', site.url + '/Cat-57-1', 'getMovies', site.image)
    site.add_dir('أفلام وثائقية', site.url + '/Cat-23-1', 'getMovies', site.image)
    site.add_dir('مسلسلات عربية', site.url + '/Cat-98-1', 'getTVShows', site.image)
    site.add_dir('مسلسلات تركية', site.url + '/Cat-128-1', 'getTVShows', site.image)
    site.add_dir('مسلسلات تركية مدبلجة', site.url + '/Cat-129-1', 'getTVShows', site.image)
    site.add_dir('مسلسلات هندية', site.url + '/Cat-130-1', 'getTVShows', site.image)
    site.add_dir('مسلسلات كرتون', site.url + '/Cat-56-1', 'getTVShows', site.image)
    site.add_dir('برامج تلفزيونية', site.url + '/Cat-39-1', 'getTVShows', site.image)
    site.add_dir('مسرحيات', site.url + '/Cat-44-1', 'getEpisodes', site.image)
    utils.eod()
